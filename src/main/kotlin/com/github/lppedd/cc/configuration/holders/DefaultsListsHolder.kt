...
internal class DefaultsListsHolder : ComponentHolder {
  ...
  private val typeList = CommitTokenList(CCIcons.TYPE).apply {
  ...
  private fun buildComponents(): JPanel {
    ...
    val innerTokensPanel = object : JPanel(GridLayout(1, 1, /* Lists h-gap */ 30, 1)) {
      override fun paint(g: Graphics) {
        super.paint(g)
        val x = (width - ARROW_RIGHT.iconWidth) / 2
        val y = (height - ARROW_RIGHT.iconHeight + 20) / 2
        ARROW_RIGHT.paintIcon(this, g, x, y)
      }
    }
