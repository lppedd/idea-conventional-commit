...
@JvmField val ICON_UNKNOWN_PROVIDER: Icon = IconLoader.getIcon("/icons/unknownProvider.svg")
@JvmField val ICON_DEFAULT_PRESENTATION: Icon = IconLoader.getIcon("/icons/defaultPresentation.svg")
